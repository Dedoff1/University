...
procedure cell;
begin
  writeln('Комната в которой вы очнулись...');
  readln;
  writeln('Здесь все также пусто, как и ранее');
  readln;
end;
procedure room;
begin
  ...
  readln;
  writeln('Единственное, что вы можете понять, это четыре цифры в самом конце...');
  readln;
  writeln('1375');
  readln;
...
begin
  ...
  begin
   ...
   begin
    ...
    writeln('КАМЕРА СОДЕРЖАНИЯ: АВАРИЙНАЯ БЛОКИРОВКА');
    readln;
...
procedure captainroom;
begin
  writeln('Вы подходите к двери, украшенной странным камнем, который освщает темный коридор');
  readln;
if electricity = True then
  writeln('Дверь открывается перед вами');
  readln;
  writeln('Внутри вы видите комнату, усеянную стопками бумаг');
  readln;
  writeln('Вы берете верхний лист из одной из таких стопок');
  readln;
  writeln('Она наполнена научными терминами и неизвестными вам сокращениями');
  readln;
  writeln('Вас заинтересовывает несколько строк:');
  readln;
  writeln('GF-56 отличается от предыдущих особей невероятной силой и невосприимчивостью к любому оружия на Земле');
  readln;
  writeln('Необходимо усилить клетку содержания, из-за ');
  readln;
  writeln('Необходимо найти способ открыть эту дверь');
  readln;
end;
...
procedure lockroom;
begin
  writeln('Вы подходите к двери странной формы');
  readln;
  if electricity = True then
  begin
  writeln('Она незамедлительно открывается перед вами...');
  readln;
  writeln('Эта комната белого цвета и она абсолютно пуста');
  readln;
  writeln('Стены ее покрыты следами от когтей');
  readln;
  writeln('Что могло оставить такие следы?');
  readln;
  writeln('Собираясь уходить вы замечаете сверху оторванную сетку от вентиляции');
  readln;
  writeln('Вам становится не по себе');
  readln;
  end
  ...
  writeln('АВАРИЙНАЯ БЛОКИРОВКА ВКЛЮЧЕНА');
  readln;
  writeln('Из-за двери доносятся странные звуки, напоминающий рык животного');
  readln;
  writeln('И вдруг звуки замолкают, будто что-то внутри почувствовало вас');
  readln;
  writeln('Вам не хочется даже думать, что может быть там внутри...');
  readln;
  end;
end;
procedure floor3map;
...
begin
 ...
 if floor = 2 then
 writeln('4. Камера содержания')
 else
 writeln('4. Каюта капитана');
 writeln('Куда идти?');
  repeat
  readln(enter1);
