...
const KastilTrim = 2 // TODO maybe 2
...
var Clientpath = "C:\\Users\\1\\Desktop\\http-file-share\\client\\" // TODO change to your's
var UserDir = "/http-file-share/client"
...
`,
		...
		input = input[:len(input)-KastilTrim]
...
func Create() {
	...
	filePath = filePath[:len(filePath)-KastilTrim]

	fmt.Println(Clientpath + filePath)
	...
	writer.Close()
	//UserName
	req, err := http.NewRequest("PUT", baseUrl+"/file/"+UserName, body)
	if err != nil {
...
func Append() {
	...
	filePathServer = filePathServer[:len(filePathServer)-KastilTrim]
...
func Get() {
	...
	file, err := os.Create(fileName[:len(fileName)-KastilTrim])
	if err != nil {
...
func Delete() {
	...
	sourceFile = sourceFile[:len(sourceFile)-KastilTrim]
...
func Copy() {
	...
	destinationFile = destinationFile[:len(destinationFile)-KastilTrim]
