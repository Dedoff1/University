...
namespace oop
{
    public class GameField : RectangleObject
    {
        ...
        private readonly int velModuloMin = 50;
        private readonly int velModuloMax = 300;

        // acceleration value ranges
        private readonly int accModuloMin = 20;
        private readonly int accModuloMax = 100;
        ...
        private double timeNextCollision;
        private int idxCollisionSource;
        private int idxCollisionDest;

        private int lastKnownAmount;
        private const int threadsAmnt = 4;
