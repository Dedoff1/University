...
namespace Figures.Figures
{
    public class GameField : Rectangle
    {
        ...
        public DisplayObject[] objectsToRender = new DisplayObject[18];
        ...
        {
            generateRandomRectangles(3);
            generateRandomEllipses(3);
            generateRandomTriangles(3);
            generateRandomCircles(3);
            generateRandomSquares(3);
