...
#pragma warning disable 8602,8600, 8604
namespace oop3.Utilities
{
    internal class ObjectInitializer
    {
        ...
        private static readonly int amntOfObjects = 15;
        ...
        public static (GameField, DisplayObject[]) generateDrawField(int leftTopX, int leftTopY, int bottomRightX, int bottomRightY, int thickness, bool acceleration)
        {
            ...
            CDrawField.fillColor = Color.FromArgb(random.Next(0,255), random.Next(0,255), random.Next(0, 255));
            CDrawField.strokeColor = Color.FromArgb(random.Next(0, 255), random.Next(0, 255), random.Next(0, 255));
        ...
        {
            int width = 0;//generateWidth();
            int height = 250;//generateHeight();
